...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">BookShop <sup>2</sup></div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="cards.html">Order in process</a>
                </div>
            </div>
        </li>
        ...
        <!-- Nav Item - Pages Collapse Menu -->
        <li class="nav-item">
            <a class="nav-link collapsed" href="users" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <li class="nav-item dropdown no-arrow mx-1">
                        <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <!-- Counter - Alerts -->
                            <span class="badge badge-danger badge-counter">@isset($feedback) {{$newfeedback}}@endisset</span>
                        </a>
                        <!-- Dropdown - Alerts -->
    ...
    $(document).ready(function () {
        ...
        $('.edit').on('click', function () {
            ...
            $('#userEdit').on('click', function (e) {
                ...
                $.ajax({
                    type: 'PATCH',
                    url: 'http://127.0.0.1:8000/admin/users/' + id,
                    data: {
                        // 'id': id,
                        'name': name,
                        'email': email,
